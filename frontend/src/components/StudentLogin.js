    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (errorMessage === 'Your account is pending admin approval') {
                setError('Your student account is pending admin approval.');
            } else {
                setError(errorMessage || 'Invalid student credentials.');
            }
        } finally {
            setIsLoading(false);
        }
            ...
            <div style={{
                ...
                <div style={{ textAlign: 'center', marginBottom: '40px' }}>
                    <div style={{
                        ...
                        justifyContent: 'center',
                        margin: '0 auto 20px',
                        boxShadow: '0 15px 35px rgba(33, 150, 243, 0.3)',
                    ...
                    <div style={{ marginBottom: '25px' }}>
                        ...
                        <div style={{ position: 'relative' }}>
                            <input
                                ...
                                onBlur={(e) => {
                                    e.target.style.borderColor = 'rgba(33, 150, 243, 0.2)';
                    ...
                    <button
                        ...
                        onMouseEnter={(e) => {
                            if (!isLoading) {
                                ...
                                e.currentTarget.style.boxShadow = '0 20px 45px rgba(33, 150, 243, 0.4)';
                            }
                        }}
                        onMouseLeave={(e) => {
                            if (!isLoading) {
                                e.currentTarget.style.transform = 'translateY(0)';
                                e.currentTarget.style.boxShadow = '0 15px 35px rgba(33, 150, 243, 0.3)';
                            }
                        }}
                    >
                        {isLoading ? 'Authenticating...' : 'Access Student Portal'}
                    </button>
                </form>
